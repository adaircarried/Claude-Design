...
ACT = [
 ...
 ("I", "Documentos de control: WPS, PQR, hoja de parámetros", "Parcial",
  P((0,1)),  P((0,7)), True),
 ("HITO", "Sesión teórica formal y examen 8.0", "Pendiente",
  P((9,11)), P(), True),
 ...
 ("U", "Creación de programa nuevo de soldadura", "Parcial",
  P((9,18)), P((5,7)), False),
 ("U", "Crear programa en SKS", "No iniciado", P((9,18)), P(), False),
 ...
 ("O", "Capacitar a personal nivel 2 o 3", "No iniciado", P((15,21)), P(), False),
 ("O", "Implementación de ideas de mejora", "No iniciado", P((15,20)), P(), False),
 ("O", "Problem solving: 7 básicos, 5W+2H, 8D, Ishikawa", "No iniciado",
  P((15,21)), P(), True),
 ("O", "GD&T", "No iniciado", P((15,21)), P(), True),
 ("O", "Cierre de órdenes del ANDON", "Dominado", P((0,21)), P((0,7)), False),
 ("O", "Lean Manufacturing", "No iniciado", P((15,21)), P(), True),
...
r += 1
put(r, C_ACT, "Fila Plan: cuándo estaba programada la actividad.  Fila Real: cuándo ocurrió de verdad.", size=9, border=False)
